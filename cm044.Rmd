...
ggplot(givers, aes(x = factor(number_envelopes), y = prop_given, 
...
ggplot(givers, aes(x = age_groups, y = prop_given, colour = factor(number_envelopes))) +
  stat_summary(fun.y = mean, geom = "point") + 
  stat_summary(fun.y = mean, geom = "line", aes(group = number_envelopes)) +
