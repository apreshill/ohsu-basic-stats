...
Use this [kaggle dataset](https://www.kaggle.com/hakabuk/us-presidents-heights-how-low-can-u-go), and do a two-sample t-test to test whether there is a difference in mean heights between men on the "OKCupid" dating site, versus all our POTUSes. I saved the dataset [here](http://bit.ly/conj620-potusheights), then did the following:
