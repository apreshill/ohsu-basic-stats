...
- Use `knitr::kable(format = 'html')` to make this table look pretty in your rendered homework.
...
- Use `knitr::kable(format = 'html')` to make these tables look pretty in your rendered homework.
